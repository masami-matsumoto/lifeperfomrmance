  ...
  <section class="about-wrapper">
    ...
    <div id="company" class="area">
      <table class="table-list">
        ...
        <tr>
          <th>所在地</th>
          <td>東京都府中市（自宅を事業所としているため、途中省略させていただきます）</td>
        </tr>
        <tr>
          <th>アドレス</th>
    ...
    <div id="profile" class="area">
      ...
      <h2>桑原　ゆかり</h2>
      <h3>yukari kuwahara</h3>
      <p class="txt-large">国内香水ブランド会社 10年代表として経営おりましたが、別事業を立ち上げの為、経営から退くことにしました。<br>
        商品開発の経験を生かして、2021年よりライフパフォーマンスの一員としお客様目線でのWEBデザイン・開発の協力することになりました。 </p>
      <!--/area--></div>
    <div id="service" class="area">
      <table class="table-list">
        <tr>
          <th>Web関連</th>
          <td>Webサイト制作・運用・保守 / LP制作 / CMS構築・カスタマイズ /<br>
            情報設計・ワイヤーフレーム 制作 </td>
        </tr>
        <tr>
          <th>印刷関連</th>
