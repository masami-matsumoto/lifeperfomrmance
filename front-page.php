...
<main>
  ...
  <section id="lead" class="l-content-fixed">
    ...
    <p class="sub-title">デザインからWEBサイト開発やCMS構築までワンストップで対応</p>
    <p class="txt-small">東京都府中市でフリーランスとして活動しているWeb制作事務所になります。コーポレートサイト・ランディングページ・ECサイトなどWEB制作を中心としたデザインやプログラミング、システム開発などワンストップで対応が可能です。また、印刷物なども協力会社と共に作成いたします。</p>
    <p class="txt-small">2020年から感染防止のための外出自粛、リモートワークも増え働き方が変わりつつあります。さらにはSNSの急激な普及により大量の情報が瞬時に入手できる環境が整備され、WEBサイトの構築など対応に追われることもあるかと思います。ライフパフォーマンスでは、フリーランスならではの柔らかい対応と相談しやすさを心がけています。お気軽にお問い合わせください。</p>
  </section>
    ...
    <div class="l-content-fixed">
      ...
      <ul class="about-content delayScroll">
        <li class="fadeUpTrigger"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/about-content1.png" width="320" height="160" alt=""/>
          <h4>夫婦で力を合わせ活動</h4>
          <p class="txt-small">WEBサイトのパフォーマンス向上を目指し、スキルやデザインを二人でアイデアを出し合い、一つ一つ丁寧に制作します。<br>お客様にとってより良いWEBサイト制作をお手伝いいたします。</p>
        </li>
